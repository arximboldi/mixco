...
# > - **View me [on a static web](http://sinusoid.es/mixco/test/mixco/value.spec.html)**
# > - **View me [on GitHub](https://github.com/arximboldi/mixco/blob/master/test/mixco/value.spec.coffee)**
